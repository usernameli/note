...
public class ChangePublishedActivity extends Activity {
	...
	public void Init() {
		...
		et_diaryText.setText(NoteCache.getNoteText());
		et_Title.setText(NoteCache.getNoteTitle());
		...
		noScrollgridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == Bimp.bmp.size()) {
					new PopupWindows(ChangePublishedActivity.this,
							noScrollgridview);
				} else {
					Intent intent = new Intent(ChangePublishedActivity.this,
							PhotoActivity.class);
		...
		activity_selectimg_send.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Update(et_diaryText.getText().toString(),
	...
	// }
	// }
	private void Update(String diaryText, String diaryTime, String dirayImg,
			String diaryTitle) {
		com.li.notebook.sqlite.DataBaseHelper baseHelper = new com.li.notebook.sqlite.DataBaseHelper(
				ChangePublishedActivity.this, "diary_dbs");
		...
		String[] whereArgs = { NoteCache.getNoteTime() };
		db.update("diarys", values, whereClauses, whereArgs);
		NoteCache.setToEmpty();
		finish();
	}
